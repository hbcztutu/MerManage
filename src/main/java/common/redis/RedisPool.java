...
public class RedisPool {  
    ...
    //Redis服务器IP  
    private static String ADDR_ARRAY ="23.224.108.80"; //FileUtils.getPropertyValue("/properties/redis.properties", "server");  
...
//    private static String AUTH = FileUtil.getPropertyValue("/properties/redis.properties", "auth");  
    ...
    private static int MAX_WAIT = 5000;//FileUtil.getPropertyValueInt("/properties/redis.properties", "max_wait");;  
  
    //超时时间  
    private static int TIMEOUT = 5000;//FileUtil.getPropertyValueInt("/properties/redis.properties", "timeout");;  
    ...
    public static void setString(String key ,String value){  
        try {  
            value = UtilValidate.isEmpty(value) ? "" : value;  
